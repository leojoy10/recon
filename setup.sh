                ...
                yes)
					...
					echo ""
             				...
             				wget https://go.dev/dl/go1.17.5.linux-amd64.tar.gz
                                        echo ""
                                        echo " Extract go1.17.5.linux-amd64.tar.gz into /usr/local, you will find go folder which is Go tree in /usr/local/go"
                                        sudo tar -C /usr/local -xvf go1.17.5.linux-amd64.tar.gz
					export PATH=$PATH:/usr/local/go/bin:$HOME/go/bin
					echo 'export PATH=$PATH:/usr/local/go/bin:$HOME/go/bin' >> ~/.bash_profile
					source ~/.bash_profile
					echo "removing Golang binary"
					rm -r go1.17.5.linux-amd64.tar.gz
					echo ""
...
#To get auto-complete working you need to source the gf-completion.bash file in your .bash_profile
echo 'source $HOME/go/pkg/mod/github.com/tomnomnom/gf@v0.0.0-20200618134122-dcd4c361f9f5/gf-completion.bash' >> ~/.bash_profile
source ~/.bash_profile
...
ls 
echo ""
echo "Don't forget to set up AWS credentials in!"
